                    ...
                    Container(
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(35),
                          image: DecorationImage(
                              image: new AssetImage("images/safari2.jpg"),
                              fit: BoxFit.fill)),
                    )  ,
                    Container(
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ExpandableText(
text: 'One of the biggest safari centers in the Red Sea and South Sinai, Founded in early 2007 to offer to its customers a variety of trips through the Egyptian '
    'El Gounatours offers you Hurghada Super Desert Safari Excursions to enjoy an adventurous experience across the desert.',                      maxLines:  20,
                      minLines: 5,
                      style: TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.w400,
                    ...
                    ExpandableText(
text: 'Traveling by plane is the fastest way to get from Cairo to El Gouna. While it\'s often the most expensive option, tool, occasionally you can grab promotional',                      maxLines:  20,
                      minLines: 5,
                      style: TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.w400,
