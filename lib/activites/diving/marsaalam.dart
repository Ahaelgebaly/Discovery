                    ...
                    Container(
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(35),
                          image: DecorationImage(
                              image: new AssetImage("images/diving1.jpg"),
                              fit: BoxFit.fill)),
                    )  ,
                    Container(
                    ...
                    Container(
                        ...
                        child: IconButton(
                            onPressed: () {
                              Navigator.pop(
                                  context,
                                  MaterialPageRoute(builder: (context)=> diving())
                              );
                            },
                            icon: CircleAvatar(
                              radius: 15.0,
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ExpandableText(
                      text: 'Marsa Alam is a more southerly destination in the Red Sea. Expect to encounter dolphins on the way to dive sites by boat and maybe even underwater too.'
                    ...
                    ExpandableText(
                      text: 'Everyone else can look at flights into Hurghada where which is around a 3 hour drive from Marsa Alam, or look into flights to Cairo and then a domestic flight'
