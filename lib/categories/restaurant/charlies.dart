                    ...
                    Container(
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(35),
                          image: DecorationImage(
                              image: new AssetImage("images/charlies.jpg"),
                              fit: BoxFit.fill)),
                    )  ,
                    Container(
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ExpandableText(
                      text:'Inspired by the Heliopolis of the mid 1900s; a place to make time for making time”',
                      maxLines:  20,
                      minLines: 5,
                      style: TextStyle(
                        fontSize: 12,
                    ...
                    ExpandableText(
                      text:"you can take taxi 18 min (11.7 km) via Ramses and El-Khalifa El-Maamoun",
                      maxLines:  20,
                      minLines: 5,
                      style: TextStyle(
                        fontSize: 12,
