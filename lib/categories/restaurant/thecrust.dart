                    ...
                    Container(
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(35),
                          image: DecorationImage(
                              image: new AssetImage("images/thecrust.jpg"),
                              fit: BoxFit.fill)),
                    )  ,
                    Container(
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ExpandableText(
                      text:'The first and only women-led AVPN-affiliate pizzeria in Egypt & Africa, serving true artisanal Neapolitan pizza by an AVPN-trained Pizzaiola',
                      maxLines:  20,
                      minLines: 5,
                      style: TextStyle(
                        fontSize: 12,
                    ...
                    ExpandableText(
                      text:"you can take taxi 20 min (14.6 km) via Ramses and Ezbet Fahmy, El Basatin",
                      maxLines:  20,
                      minLines: 5,
                      style: TextStyle(
                        fontSize: 12,
